...
const SalaryComparison = () => {
  ...
  const practiceOptions = [
    { key: 1, name: "Private Practice (Solo)", value: "Private Practice (Solo)" },
    { key: 2, name: "Private Practice (Group)", value: "Private Practice (Group)" },
    { key: 3, name: "Dental Service Organization (DSO) / Corporate Dentistry", value: "Dental Service Organization (DSO) / Corporate Dentistry" },
    { key: 4, name: "Community Health Center (CHC)", value: "Community Health Center (CHC)" },
    { key: 5, name: "Academic Dentistry", value: "Academic Dentistry" },
    { key: 6, name: "Public Health Dentistry", value: "Public Health Dentistry" },
    { key: 7, name: "Military Dentistry", value: "Military Dentistry" },
    { key: 8, name: "Correctional Facility Dentistry", value: "Correctional Facility Dentistry" },
    { key: 9, name: "Mobile Dentistry", value: "Mobile Dentistry" },
    { key: 10, name: "School-Based Dentistry", value: "School-Based Dentistry" },
  ];
  ...
  return (
    <>
        ...
        <div className="max-w-[80%] mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-12">
            <h1 className="text-4xl font-bold text-gray-900 mb-4">
              Physician Salary Comparison Tool
      ...
      <form className="space-y-6" onSubmit={handleSubmit(onSubmit)}>
        ...
        <div>
          ...
          {errors.totalCompensation && (
            <p className="text-red-500 text-sm mt-1">{errors.totalCompensation.message}</p>
          )}
        </div>
      ...
      <div>
        ...
        {/* Practice Setting */}
        <div>
          <label className="block text-sm font-medium text-gray-700 mb-2">Practice Setting (Optional)</label>
          <select
        ...
        >
          Analyze My Salary
            ...
            <div className="bg-white rounded-lg shadow-lg p-8">
              ...
              <div className="text-center text-gray-500 py-12">
                <p className="text-lg">
                  Enter your details to see how your compensation compares
                </p>
              </div>
            </div>
          </div>
          <div className="mt-16 prose prose-lg mx-auto">
            <h2 className="text-3xl font-bold text-gray-900 mb-6">
              About Our Physician Salary Comparison Tool
            </h2>
            <p className="text-lg text-gray-700 mb-8">
              Our physician salary comparison tool provides real-time insights
              into medical compensation across all 50 states and major medical
              specialties. Whether you're a practicing physician, in residency,
              or considering a career move, this tool helps you understand your
              market value based on actual compensation data from our physician
              salary database.
            </p>
            ...
            <p className="text-lg text-gray-700 mb-4">
              ...
              physician salaries. You'll receive:
            </p>
            ...
            <h2 className="text-3xl font-bold text-gray-900 mb-6">
              Why Compare Physician Salaries?
            </h2>
            <p className="text-lg text-gray-700 mb-4">
            ...
            <p className="text-lg text-gray-700 mt-8">
              Looking to calculate your take-home pay? Use our Physician Take
